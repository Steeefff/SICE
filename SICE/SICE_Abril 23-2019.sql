...
-- CHANGE MASTER TO MASTER_LOG_FILE='DESKTOP-15DI8I9-bin.000053', MASTER_LOG_POS=155;
...
--
-- Table structure for table `fechasdepago`
--

DROP TABLE IF EXISTS `fechasdepago`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `fechasdepago` (
  ...
  CONSTRAINT `idEstudianteFechasPagos` FOREIGN KEY (`idEstudiante`) REFERENCES `personas` (`identificacion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fechasdepago`
--

LOCK TABLES `fechasdepago` WRITE;
/*!40000 ALTER TABLE `fechasdepago` DISABLE KEYS */;
INSERT INTO `fechasdepago` VALUES ('504120599','2019-04-27');
/*!40000 ALTER TABLE `fechasdepago` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `matriculas` VALUES (6,'504120598','GRUPO 1s','2019-04-21'),(7,'504120599','GRUPO III','2019-04-21');
...
--
-- Temporary view structure for view `vista_pendientesdepago`
--

DROP TABLE IF EXISTS `vista_pendientesdepago`;
/*!50001 DROP VIEW IF EXISTS `vista_pendientesdepago`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vista_pendientesdepago` AS SELECT 
 1 AS `idEstudiante`,
 1 AS `fechaProxPago`,
 1 AS `fechaPagada`,
 1 AS `fechaDelPago`*/;
...
--
-- Final view structure for view `vista_pendientesdepago`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_pendientesdepago` AS select `pagos`.`idEstudiante` AS `idEstudiante`,`fechasdepago`.`fechaProxPago` AS `fechaProxPago`,`pagos`.`fechaPagada` AS `fechaPagada`,`pagos`.`fechaDelPago` AS `fechaDelPago` from (`pagos` join `fechasdepago`) where (`pagos`.`idEstudiante` = `fechasdepago`.`idEstudiante`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-04-23 23:02:34
