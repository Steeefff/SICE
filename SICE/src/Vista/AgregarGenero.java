...
public class AgregarGenero extends javax.swing.JFrame {
    ...
    public AgregarGenero(Image icono,Conexion conexion,ResultSet rs,Statement st) {
        initComponents();
    ...
    private void insertarGenero() throws SQLException{
        //Crea un objeto de tipo idiomas
        Generos genero= new Generos(this.conexion,this.rs,this.st);
        ...
        String respuestaRegistro = generosDAO.insertaGenero(genero);
        ...
        if(respuestaRegistro!=null){
         ...
         JOptionPane.showMessageDialog(null, "El género "+genero.getNombre()+" ya existe en el registro.");
        }
    }
