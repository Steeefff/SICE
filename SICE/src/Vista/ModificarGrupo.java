...
public class ModificarGrupo extends javax.swing.JFrame {
    ...
    public ModificarGrupo(Image icono,Conexion conexion,ResultSet rs,Statement st,String codigoBuscado) throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 322, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        tablaGrupos.setRowSelectionAllowed(true);
        ...
        tablaGrupos.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void modificarGrupo(){
        //Crea un objeto de tipo grupo
        Grupos grupos= new Grupos();
        //Se cargan los atributos del grupo
        ...
        grupos.setEstado(1);
        grupos.setIdProfesor(this.profesores.get(this.comboProfesor.getSelectedIndex()).getIdentificacion());
        grupos.setIdcurso(this.cursos.get(this.comboCurso.getSelectedIndex()).getIdcurso());
        grupos.setDia(this.comboDia.getItemAt(this.comboDia.getSelectedIndex()));
        grupos.setHoraInicio(this.comboHoras.getItemAt(this.comboHoras.getSelectedIndex())+":"+this.comboMinutos.getItemAt(this.comboMinutos.getSelectedIndex()));
        ...
        boolean modificado = gruposDAO.modificar(grupos,this.codigoBuscado);
    }
    ...
    public void buscar(String idGrupos){
        //Se crea un objeto de tipo Grupos
        Grupos gruposAux= null;
        this.txtCodigo.setText(idGrupos);
        try {
            ...
            if(gruposAux==null){
                //Se limpian los datos de las busquedas anteriores y se habilita el formulario para modificar el grupo
                limpiar();
