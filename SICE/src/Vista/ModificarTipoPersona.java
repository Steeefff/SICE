...
public class ModificarTipoPersona extends javax.swing.JFrame {
    ...
    private void modificarTipoPersona() throws SQLException{
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        if(validaciones()==true){
            try {
                ...
                Logger.getLogger(ModificarTipoPersona.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }//GEN-LAST:event_btnModificarActionPerformed

    public void buscar(String rol){
