...
public class Permisos {
    ...
    private Boolean administracionUsuarios;

    public Permisos() {
    }
    
        public Permisos(int idPermiso, String descripcion, Boolean matricular, Boolean agregarCurso, Boolean agregarGrupo, Boolean agregarProfesor, Boolean agregarEstudiante, Boolean mantenimientoCurso, Boolean mantenimientoGrupo, Boolean mantenimientoProfesor, Boolean mantenimientoEstudiante, Boolean mantenimientoSistema,Boolean administracionUsuarios) {
    ...
    public Boolean getAdministracionUsuarios() {
        return administracionUsuarios;
    }

    public void setAdministracionUsuarios(Boolean administracionUsuarios) {
        this.administracionUsuarios = administracionUsuarios;
    }
