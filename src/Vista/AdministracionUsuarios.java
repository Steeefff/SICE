...
public class AdministracionUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablaUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identificación", "Nombre", "Contraseña", "Rol"
            }
        ) {
        ...
        btnActualizar.setBackground(new java.awt.Color(0, 133, 202));
    ...
    public void mostrar() {
        try {
            ...
            modelo = personasDAO.mostrarBuscarUsuarios();
    ...
    private void btnMantenimientoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMantenimientoActionPerformed
        modificarUsuario = new ModificarUsuario(this.icon,this.conexion,this.rs,this.st,this.lbId1);
    ...
    private void tablaUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaUsuariosMouseClicked
        ...
        lbId1=tablaUsuarios.getValueAt(fila, 0).toString();
