...
public class MantenimientoCursos extends javax.swing.JFrame {
    ...
    public MantenimientoCursos(Image icono,Conexion conexion,ResultSet rs,Statement st) {
        initComponents();        
    ...
    private void initComponents() {
        ...
        lbl.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(204, 204, 204), new java.awt.Color(204, 204, 204)));

        tablaGrupos.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        lblLayout.setHorizontalGroup(
            ...
            .addGroup(lblLayout.createSequentialGroup()
                ...
                .addGroup(lblLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(lblLayout.createSequentialGroup()
                            ...
                            .addGroup(lblLayout.createSequentialGroup()
                                .addGroup(lblLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(lblLayout.createSequentialGroup()
                                        ...
                                        .addGap(1, 1, 1)
                                        .addComponent(lbId1, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(lblLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(lblLayout.createSequentialGroup()
                                ...
                                .addGroup(lblLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btnModificar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnDeshabilitar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnHabilitar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(lblLayout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(lblLayout.createSequentialGroup()
                        ...
                        .addGroup(lblLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(lblLayout.createSequentialGroup()
                                ...
                                .addGroup(lblLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(lbSeleccionado)
                                    .addComponent(lbId1, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(lblLayout.createSequentialGroup()
                                .addGap(27, 27, 27)
                                .addComponent(lbCod))))
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLbFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0))
        );
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        ...
        ventanaPrincipal.lblUsuario.setText(this.lblUsuario.getText());
    ...
    private void btnHabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHabilitarActionPerformed
        if(!this.lbSeleccionado.getText().equals("") & this.lbSeleccionado.isEnabled()==true){
            ...
            cursosDAO.habilitar(lbSeleccionado.getText());
    ...
    private void btnDeshabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeshabilitarActionPerformed
        if(!this.lbSeleccionado.getText().equals("") & this.lbSeleccionado.isEnabled()==true){
            this.cursosDAO= new CursosDAO(this.conexion,this.rs,this.st);
            cursosDAO.deshabiliar(lbSeleccionado.getText());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if(this.lbSeleccionado.getText().equals("")){
            ...
            try {
                modificarCurso.txtCodigo.setText(this.lbSeleccionado.getText());
                modificarCurso.buscar(this.lbSeleccionado.getText());
                modificarCurso.codigoBuscado=this.lbSeleccionado.getText();
    ...
    private void tablaGruposMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaGruposMouseClicked
        ...
        this.lbSeleccionado.setText(tablaGrupos.getValueAt(fila, 0).toString()); 
    ...
    void mostrar(String buscar) {
        try {
            this.cursosDAO= new CursosDAO(this.conexion,this.rs,this.st);
            DefaultTableModel modelo;
            modelo = cursosDAO.mostrarBuscarCursos(buscar);
