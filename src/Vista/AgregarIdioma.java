...
public class AgregarIdioma extends javax.swing.JFrame {
    ...
    public AgregarIdioma(Image icono,Conexion conexion,ResultSet rs,Statement st) {
        initComponents();
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(txtIdioma, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(150, 150, 150))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel2)
                .addGap(33, 33, 33)
                .addComponent(txtIdioma, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private boolean validarEspacios(){
        ...
        if(!this.txtIdioma.getText().equals(""))
                completo = true;
        else
            JOptionPane.showMessageDialog(null, "Es necesario completar el espacio para idioma.");
           return completo;
    }
    
    private void insertarIdioma() throws SQLException{
        //Crea un objeto de tipo idiomas
        Idiomas idioma= new Idiomas();
        //Se cargan los atributos del idioma
        idioma.setNombre(txtIdioma.getText());

        //Envía el idioma al método insertaIdioma del idiomasDAO que inserta en la base de datos
        idiomasDAO = new IdiomasDAO(this.conexion,this.rs,this.st);
        String respuestaRegistro = idiomasDAO.insertaIdioma(idioma);
        //Si respuestaRegistro es diferente de null quiere decir que se ingresó el idioma correctamente
        if(respuestaRegistro!=null){
            JOptionPane.showMessageDialog(null, respuestaRegistro);
            Limpiar();
        }else{
         JOptionPane.showMessageDialog(null, "El idioma "+idioma.getNombre()+" ya existe en el registro.");
        }
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(validaciones()==true){
            try {
                ...
                Logger.getLogger(AgregarIdioma.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
