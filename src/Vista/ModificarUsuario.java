...
public class ModificarUsuario extends javax.swing.JFrame {
  ...
  Image icon;
    ...
    public ModificarUsuario(Image icono,Conexion conexion,ResultSet rs,Statement st, String idBuscado) {
        initComponents();
        this.setSize(522,710); 
    ...
    private void initComponents() {
        ...
        jPanel3.setMaximumSize(new java.awt.Dimension(522, 56));
        jPanel3.setMinimumSize(new java.awt.Dimension(522, 56));
        jPanel3.setName(""); // NOI18N
        jPanel3.setPreferredSize(new java.awt.Dimension(522, 56));
    ...
    private void modificarUsuario(){
        ...
        if(respuestaRegistro==true){
            JOptionPane.showMessageDialog(null, "El usuario "+persona.getNombre()+" ha sido modificado con éxito.");
            Limpiar();
        }else{
    ...
    public void mostrar(Usuarios usuario) throws ParseException{
        this.txtIdentificacion.setText(" ");        
        habilitar();    
        this.txtIdentificacion.setText(usuario.getIdentificacion());
        this.txtNombre.setText(usuario.getNombre());     
        this.txtContrasena.setText(usuario.getContraseña());
        this.comboRol.setSelectedIndex(usuario.getIdRol()-2);          
    } 
    ...
    public void buscar(String identificacion){
        ...
        if(identificacion.length()>=1){
            ...
            try {
                ...
                personasDAO = new PersonasDAO(this.conexion,this.rs,this.st);
                usuario = personasDAO.buscarUsuario(identificacion);
            ...
            if(usuario==null){
               //Se limpian los datos de las busquedas anteriores y se habilita el formulario para agregar al estudiante
               //limpiar();
               ...
               habilitar();
                ...
                if(usuario.getIdRol()<3)
                {
                    ...
                    this.deshabilitar();
                    usuario=null;
                    JOptionPane.showMessageDialog(null, "Error! Esta persona no es válida.");
                }else{
                    try {
